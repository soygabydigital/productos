...
@section('content')
    <section class="section">
        <div class="section-header">
            <h4 class="page__heading">Crear Producto</h4>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('categoria_id',$categorias,[],array('class'=>' form-control categoria_id','id'))  !!}
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="stock_prod">Stock Inicial</label>
                                        {!! Form::text('stock_prod',null,array('class'=>'form-control'))  !!}
                                    </div>
                                    </div>
